...
Bitcoin wallet management. Create wallets from seed phrases, import watch-only accounts (xpub) and signing accounts (xprv), derive addresses, scan balances, and send transactions.

View at `/grubbery/ball/wallet/`.
