    ...
    ;body
      ...
      ;script
        ...
        ;:  weld
          ...
          "  });\0a"
          "  fetch(OVER+'rates.json?blot=/json',\{method:'POST',headers:\{'content-type':'application/json'},body:JSON.stringify(obj)\0a"
          "  }).then(r=>\{\0a"
          ...
          "  fetch(OVER+'usage.json?blot=/json',\{method:'POST',headers:\{'content-type':'application/json'},\0a"
