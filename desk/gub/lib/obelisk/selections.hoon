...
/<  scalars  /lib/obelisk/scalars.hoon
/<  mip  /lib/mip.hoon
=,  obelisk-types
=,  server-state
=,  sys-views
...
::
++  join-all
  ::  db-state state returned because we may have updated the view cache
...
++  source-full-relation
  ...
  ?-  -.rel
    %qualified-table
      ...
      =/  sys-time=@da  (set-tmsp as-of now)
