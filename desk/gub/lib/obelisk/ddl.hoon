...
++  create-ns
  |=  $:  =create-namespace:ast
      ...
      ==
  ^-  [cmd-result:ast (map @tas @da) db-state]
  ...
  =/  sys-time  (set-tmsp as-of.create-namespace now)
  =/  nxt-schema=schema
