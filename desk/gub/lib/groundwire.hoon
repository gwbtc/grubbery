::  lib/groundwire.hoon
::
::  Taproot keypairs, tx construction, and BIP341 sighash logic
::  for building and signing urb-bearing bitcoin transactions.
::
::  Ported from groundwire's lib/groundwire.hoon.
::
