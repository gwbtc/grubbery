...
++  no-lib
  ...
  =/  temp=^path
    ?+  path  !!
      [%base *]  /lib/base/template
      [%stem *]  /lib/stem/template
      [%gui %con %base *]  /lib/gui/con/template/base
      [%gui %con %stem *]  /lib/gui/con/template/stem
      [%gui %con %stud *]  /lib/gui/con/template/stud
      [%gui %con %mime *]  /lib/gui/con/template/mime
